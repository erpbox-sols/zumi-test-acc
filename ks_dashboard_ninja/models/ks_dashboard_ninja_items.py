...
class KsDashboardNinjaItems(models.Model):
    ...
    ks_compare_period_2 = fields.Integer(string="Include Period 2")
    ks_year_period_2 = fields.Integer(string="Same Period Previous Years 2")
    ...
    ks_domain_extension_2 = fields.Char('Domain Extension 2')
    # hide legend
